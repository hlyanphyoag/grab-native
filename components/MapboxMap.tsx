...
// Set Mapbox access token (you'll need to get a free one from mapbox.com)
Mapbox.setAccessToken('pk.eyJ1IjoiaGx5YW5waHlvIiwiYSI6ImNtZXJiaTRzbjAwZG0yaXNhYTFiMnAwZXAifQ.BRH57AFtxX2UWr18ZMMPwg'); // Replace with your token
...
export default function MapboxMap() {
  ...
  console.log('Mapbox render - User location:', { userLatitude, userLongitude });
  console.log('Mapbox render - Markers count:', markers?.length);

  return (
    <View style={{ height: '100%', width: '100%', borderRadius: 16, overflow: 'hidden' }}>
      <MapView
        style={{ flex: 1 }}
        styleURL="mapbox://styles/mapbox/streets-v12" // Free Mapbox style
        zoomEnabled={true}
        scrollEnabled={true}
